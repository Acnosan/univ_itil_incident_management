...
urlpatterns = [
    ...
    path("ticket/<str:ticket_title>/",ticket_views.console_ticket,name="console_ticket"),
    path("ticket/update/<str:ticket_title>/",ticket_views.update_ticket,name="update_ticket_form"),
    ...
    path("ticket/solution/<str:ticket_title>/",ticket_views.add_solution,name="add_solution_form"),
