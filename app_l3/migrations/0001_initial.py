# Generated by Django 5.0.2 on 2024-04-12 20:54
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='StatusModel',
            fields=[
                ('status_name', models.CharField(choices=[('new', 'New'), ('pending', 'Pending'), ('ongoing', 'Ongoing'), ('solved', 'Solved'), ('closed', 'Closed')], max_length=150, primary_key=True, serialize=False, unique=True)),
                ('description', models.TextField()),
